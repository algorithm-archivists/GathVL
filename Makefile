...
BINS = vis_test
OBJ = vis_test.o layer.o scene.o camera.o shapes.o animators.o
DEPS = include/vec.h include/scene.h include/layer.h include/camera.h include/shapes.h include/animators.h
